...
#define EBPF_BTF_RESOLVED_FUNCTIONS_REGISTRY_KEY L"BtfResolvedFunctions"
#define EBPF_BTF_FUNCTIONS_REGISTRY_KEY L"Functions"
...
#define EBPF_BTF_FUNCTION_DATA_RETURN_TYPE L"ReturnType"
#define EBPF_BTF_FUNCTION_DATA_ARGUMENTS L"Arguments"
#define EBPF_BTF_FUNCTION_DATA_FLAGS L"Flags"
...
#define EBPF_BTF_RESOLVED_FUNCTION_PROTOTYPE_CURRENT_VERSION 1
#define EBPF_BTF_RESOLVED_FUNCTION_PROTOTYPE_CURRENT_VERSION_SIZE \
    EBPF_SIZE_INCLUDING_FIELD(ebpf_btf_resolved_function_prototype_t, flags)
#define EBPF_BTF_RESOLVED_FUNCTION_PROTOTYPE_CURRENT_VERSION_TOTAL_SIZE sizeof(ebpf_btf_resolved_function_prototype_t)
#define EBPF_BTF_RESOLVED_FUNCTION_PROTOTYPE_HEADER             \
    {EBPF_BTF_RESOLVED_FUNCTION_PROTOTYPE_CURRENT_VERSION,      \
     EBPF_BTF_RESOLVED_FUNCTION_PROTOTYPE_CURRENT_VERSION_SIZE, \
...
#define EBPF_BTF_RESOLVED_FUNCTION_PROVIDER_DATA_CURRENT_VERSION 1
#define EBPF_BTF_RESOLVED_FUNCTION_PROVIDER_DATA_CURRENT_VERSION_SIZE \
    EBPF_SIZE_INCLUDING_FIELD(ebpf_btf_resolved_function_provider_data_t, btf_resolved_function_addresses)
#define EBPF_BTF_RESOLVED_FUNCTION_PROVIDER_DATA_CURRENT_VERSION_TOTAL_SIZE \
    sizeof(ebpf_btf_resolved_function_provider_data_t)
#define EBPF_BTF_RESOLVED_FUNCTION_PROVIDER_DATA_HEADER             \
    {EBPF_BTF_RESOLVED_FUNCTION_PROVIDER_DATA_CURRENT_VERSION,      \
     EBPF_BTF_RESOLVED_FUNCTION_PROVIDER_DATA_CURRENT_VERSION_SIZE, \
...
#define EBPF_BASE_MAP_PROVIDER_DISPATCH_TABLE_V1_SIZE_0 \
